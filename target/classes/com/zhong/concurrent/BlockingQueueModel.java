...
public class BlockingQueueModel implements Model {
    ...
    public BlockingQueueModel(int cap) {
        ...
        this.queue_material = new LinkedBlockingQueue<>(10000);
    }
    ...
    private class MaterialImpl extends AbstractMaterial implements Material, Runnable {
        ...
        public  void material() throws InterruptedException {
            ...
            //同步锁，只有当当前线程执行完成后，才可执行下一线程
            synchronized(this) {
                System.out.println(Thread.currentThread().getName() + " 正在访问 " + material_begin + " - " + (material_begin + 10000));
                map = RedisWrapper.getRecords(material_begin,material_begin+10000);
                System.out.println("map:"+map.size());
                material_begin += 10000;
...
//                    }
    ...
    private class ProducerImpl extends AbstractProducer implements Producer, Runnable {
        ...
        public void produce() throws InterruptedException {
            ...
            try {
                Task task = EDBSetup_split_memory.EDBSetupBS(tm.getKeyword(), tm.getFilenames());
                queue.put(task);
    ...
    public static void main(String[] args) {
        Model model = new BlockingQueueModel(5000);
